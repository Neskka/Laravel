...
<footer class="footer">
    ...
    <div class="footer-item"><img src="{{ asset('zdjecia/telefon.png') }}" alt=""> 510 930 214</div><br>
    <div class="footer-item"><img src="{{ asset('zdjecia/email.png') }}" alt=""> <a href="mailto:konrad_filipek@o2.pl">konrad_filipek@o2.pl</a></div><br>
    <div class="footer-item"><img src="{{ asset('zdjecia/money.png') }}" alt=""> PL 12 3456 7890 1234 5678 9012 3456</div>
    <div class="stopka">&copy;KF</div>
</footer>
