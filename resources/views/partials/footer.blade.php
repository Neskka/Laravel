...
<footer class="footer">
    ...
    <div class="footer-item"><img src="{{ asset('zdjecia/telefon.png') }}" alt=""> 535 999 990</div><br>
    <div class="footer-item"><img src="{{ asset('zdjecia/email.png') }}" alt=""> <a href="mailto:aga.marzeda@gmail.com">aga.marzeda@gmail.com</a></div><br>
